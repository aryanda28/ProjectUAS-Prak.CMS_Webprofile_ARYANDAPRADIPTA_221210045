                ...
                <div class="col-xxl-5">
                    ...
                    <div class="text-center text-xxl-start">
                        <div class="badge bg-gradient-primary-to-secondary text-white mb-4">
                            <div class="text-uppercase">{!! $home->main_title !!} &middot;</div>
                        </div>
                        <div class="fs-3 fw-light text-muted">{{ $home->subtitle1 }} </div>
                        <h1 class="display-3 fw-bolder mb-5"><span class="text-gradient d-inline">{{ $home->subtitle2 }}
                            </span></h1>
                        <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3">
                            <a class="btn btn-primary btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder"
                                href="{{ route('resume') }}">{{ $home->left_button_text }} </a>
                            <a class="btn btn-outline-dark btn-lg px-5 py-3 fs-6 fw-bolder"
                                href="{{ route('contact') }}">{{ $home->right_button_text }} </a>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-7">
                    ...
                    <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                        <div class="profile">
                            ...
                            {{-- {{ $home->image_path }} --}}
                            <img class="profile-img rounded" height="100px"
                                src="{{ asset('storage/' . $home->image_path) }} " alt="..." />
                            <div class="dots-1">
                                <!-- SVG Dots-->
            ...
            <div class="row gx-5 justify-content-center">
                <div class="col-xxl-8">
                    <div class="text-center my-5">
                        ...
                        <p class="lead fw-light mb-4">{{ $home->about_me_section_title }} </p>
                        <p class="text-muted">{{ $home->about_me_section_description }}</p>
                        <div class="d-flex justify-content-center fs-2 gap-4">
                            <a class="text-gradient" target="_blank"
                                href="https://youtube.com/@aryandapradipta3788?si=MuNJ7dCPxwFAYig3"><i
                                    class="bi bi-youtube"></i></a>
                            <a class="text-gradient"
                                href="https://github.com/aryanda28/ProjectUAS-Prak.CMS_Webprofile_ARYANDAPRADIPTA_221210045"
