                ...
                <div class="col-xxl-5">
                    ...
                    <div class="text-center text-xxl-start">
                        <div class="badge bg-gradient-primary-to-secondary text-white mb-4">
                            <div class="text-uppercase">404 Error &middot;</div>
                        </div>
                        <h1 class="display-3 fw-bolder mb-5"><span class="text-gradient d-inline">Page Not Found</span></h1>
                        <p class="fs-3 fw-light text-muted">Sorry, the page you are looking for does not exist.</p>
                        <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3">
                            <a class="btn btn-primary btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder" href="{{ url('/') }}">Go
                                to Homepage</a>
            ...
            <div class="row gx-5 justify-content-center">
                <div class="col-xxl-8">
                    <div class="text-center my-5">
                        <h2 class="display-5 fw-bolder"><span class="text-gradient d-inline">Need Help?</span></h2>
                        <p class="lead fw-light mb-4">If you need further assistance, feel free to get in touch with us. We
                            are here to help you.</p>
                        <p class="text-muted">You can also return to the <a href="{{ url('/') }}">homepage</a> or
                            explore other sections of our website.</p>
                        <div class="d-flex justify-content-center fs-2 gap-4">
                            <a class="text-gradient" href="https://twitter.com"><i class="bi bi-twitter"></i></a>
                            <a class="text-gradient" href="https://linkedin.com"><i class="bi bi-linkedin"></i></a>
